     ...
     <body>
            ...
            <div class="geral--titulo__container">
                <div class="geral--item__inteiro--100">
                    <h1 class="geral--titulo__container--h1">NÃO ENVIADO</h1>
                </div>
            </div> <!-- Fim: Título -->

            <div class="envio__container">
              <img src="../assets/imagens/enviado.png"><br><br>
              <h4>Não foi possível enviar seu formulário. Por favor, tente novamente mais tarde ou entre em contato por meio das nossas redes sociais.</h4><br>
